...
public class adminInterface {
   public static void admin_InterFace () throws ClassNotFoundException, SQLException, IOException
   {
              ...
              if (admin.cheack(aum, apass))
              {
                  ...
                  do
                  {
                   ...
                   System.out.println("8)Get contract by metercode.");
                   ...
                   switch (aChoise)
                   {
                       ...
                       case 4:
                       {
                           ...
                           int mc = admin.manualAdd(name, mail,password, region, address,contract);
                       ...
                       case 5:
                       {
                           ...
                           System.out.print("Enter customer metercode : ");
                           int meter = input.nextInt();
                           
                           admin.update_name(name, meter);
